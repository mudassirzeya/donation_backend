...
from .views import login_page, admin_page, home_page, logout_user, members_info_page, member_remark, mobile_user_page, admin_team_page, delete_member, send_member_data, edit_member_info, member_search_mobile, member_create_mobile, member_remark_mobile, member_donation_mobile, mobile_login, user_donation_report, money_overflow_page, all_donation, presentation_mobile, presentation_page
...
urlpatterns = [
    ...
    path('presentations/', presentation_page, name='presentations'),
    ...
    path('presentation_mobile/', presentation_mobile,
